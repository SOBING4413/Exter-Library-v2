...
function Exter:CreateWindow(config)
    ...
    local windowTransparency = math.clamp(config.WindowTransparency or 0.1, 0, 0.9)
    local panelTransparency = math.clamp(config.PanelTransparency or 0.05, 0, 0.9)
    ...
    function window:Notify(cfg)
        ...
        Tween(card, 0.2, {BackgroundTransparency = panelTransparency, Position = card.Position - UDim2.fromOffset(30, 0)})
